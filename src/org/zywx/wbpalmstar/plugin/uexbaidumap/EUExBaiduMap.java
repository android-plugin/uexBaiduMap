...
//            mapBaseFragment = null;
    ...
    private void handleSetMapType(String[] params,
                                  EBaiduMapBaseFragment eBaiduMapBaseFragment) {
        try {
    ...
    private void handleSetMarkerOverlay(String[] params,
                                       EBaiduMapBaseFragment eBaiduMapBaseFragment) {
        if (params.length != 2) {
            return;
        }
    ...
    private void handlePoiNearbySearch(String[] params,
        ...
        try {
            ...
            String pageNum = json
                    .getString(EBaiduMapUtils.MAP_PARAMS_JSON_KEY_PAGENUM);
            eBaiduMapBaseFragment.poiNearbySearch(Double.parseDouble(lng),
    ...
    private void handlePoiBoundSearch(String[] params,
        ...
        try {
            ...
            String pageNum = jsonObject
                    .getString(EBaiduMapUtils.MAP_PARAMS_JSON_KEY_PAGENUM);
            eBaiduMapBaseFragment.poiBoundSearch(Double.parseDouble(lngNE),
    ...
    private void handleRemoveBusLine(String[] params,
                                     EBaiduMapBaseFragment eBaiduMapBaseFragment) {
    ...
    private void handleSearchRoutePlan(String[] params,
                                       EBaiduMapBaseFragment eBaiduMapBaseFragment) {
        try {
    ...
    private void handleRemoveRoutePlan(String[] params,
                                       EBaiduMapBaseFragment eBaiduMapBaseFragment) {
        try {
            if (params.length != 1) {
                return;
    ...
    private void handleSetUserTrackingMode(String[] params,
                                           EBaiduMapBaseFragment eBaiduMapBaseFragment) {
        try {
    ...
    private void handleHideMap(String[] params,
                               EBaiduMapBaseFragment eBaiduMapBaseFragment) {
        eBaiduMapBaseFragment.hideMap();
    }


    private void handleShowMap(String[] params,
                               EBaiduMapBaseFragment eBaiduMapBaseFragment) {
        eBaiduMapBaseFragment.showMap();
    }

    private void handleZoomControlsEnabled(String[] params,
                                           EBaiduMapBaseFragment eBaiduMapBaseFragment) {
        if (params.length != 1) {
            return;
        }
